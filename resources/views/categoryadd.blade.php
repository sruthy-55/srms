                ...
                <div class="card-body">
                    ...
                    @csrf
                        <div class="input-group">
                            <input class="input--style-2" type="text" placeholder="Enter category name" name="name">
                        </div>
                        
                        <div class="p-t-30">
                            <button class="btn btn--radius btn--green" type="submit" name="add" >ADD</button>
                            <button class="btn btn--radius btn--green" type="submit" name="add" >VIEW<a href="/viewcategorylist"></a></button>
