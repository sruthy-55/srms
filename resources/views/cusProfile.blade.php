...
<html><link rel="stylesheet" href="css/cusprofile.css"/>
<body>
    ...
    <header class="block">
        ...
        <div class="profile-menu">
            ...
            <div class="profile-picture small-profile-picture">
                <img width="40px" alt="Anne Hathaway picture" src="">
            </div>
        </div>
    </header>
    ...
    <div class="left-container container">
        <div class="menu-box block"> <!-- MENU BOX (LEFT-CONTAINER) -->
            ...
            <ul class="menu-box-menu">
                <li>
                    <a class="menu-box-tab" href="/foodlist"><span class="icon fontawesome-envelope scnd-font-color"></span> Menu<div class="menu-box-number">24</div></a>                            
                </li>
                <li>
                    <a class="menu-box-tab" href="/viewmenu"><span class="icon entypo-calendar scnd-font-color"></span>View Menu<div class="menu-box-number">5</div></a>                            
                </li>
                <li>
                    <a class="menu-box-tab" href="/reservation"><span class="icon entypo-paper-plane scnd-font-color"></span>Reserve Table<div class="menu-box-number">3</div></a>                            
                </li>
                <li>
                    <a class="menu-box-tab" href="/selectmenu"><span class="icon entypo-calendar scnd-font-color"></span>Select Food<div class="menu-box-number">5</div></a>                            
                </li>
                <li>
                    <a class="menu-box-tab" href="#12"><span class="icon entypo-cog scnd-font-color"></span>Account Settings</a>
                </li>
                <li>
                    <a class="menu-box-tab" href="/contact"><span class="icon entypo-chart-line scnd-font-color"></span>Feedback</a>
                </li>                        
            </ul>
        </div>
    ...
    <div class="middle-container container">
        <div class="profile block"> <!-- PROFILE (MIDDLE-CONTAINER) -->
            ...
            <div class="profile-picture big-profile-picture clear">
                <img width="150px" alt="{{$name}} " src="C:\Users\HP\srms\public\images\avt-img.jpg" >
            </div>
