...
<div class="row">
			...
			<div class="col s2 left-sidebar" id="left-sidebar">
				...
				<ul class="nav nav-sidebar list-group" class="nav-wrapper">
				    <li class="list-group-item active"><a href="admin.foodlist">Menu </a></li>
					<li class="list-group-item"><a href="admin.staffapprove">Staff Approval</a></li>
				    <!--<li class="list-group-item"><a href="category-list.php">Category</a></li>-->
					<li ><a href="admin.orderlist">View Todays Order</a></li>

				    <!--<li class="list-group-item"><a href='/orderlist'>View Todays Order</a></li>-->
				    <li class="list-group-item modal-trigger" data-target="modal1"><a href="admin.tblreserved">View Reserved Table</a></li>
				  </ul>
			</div>
				...
				<nav>
				    <div class="nav-wrapper">
				      ...
				      <ul class="right hide-on-med-and-down">
				        <li><a href="admin.adminhome">My Profile</a></li>
				        <li><a href="../">Home</a></li>
