...
<body>
<form  action="menuadded" method="post"  >
    @csrf
    ...
    <div class="page-wrapper bg-red p-t-180 p-b-100 font-robo">
        <div class="wrapper wrapper--w960">   
            <div class="card card-2">  
                ...
                <form class="login-form" action="menu_add" method="post" id="login" >
                <div class="card-body">
                    ...
                    <h2 class="title">ADD MENU</h2>
                        ...
                        <div class="input-group">
                            <input class="input--style-2" type="text" placeholder="Enter item name" name="txtName">
                        </div>
                       ...
                       <!-- <div class="input-group">
                        ...
                        <div class="input-group">
                            <input class="input--style-2" type="text" placeholder="Add description" name="txtDesc">
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                ...
                                <div class="input-group">
                                <input class="input--style-2" type="text" placeholder="current status" name="txtStatus">
                                </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                        ...
                        <div class="p-t-30">
                           <!-- <button class="btn btn--radius btn--green" type="submit" name="add" >ADD</button>
                            ...
                            <input type="submit" name="Book Now" value="Add" class="btn btn--radius btn--green" />
