        ...
        <div class="wrapper wrapper--w960">   
            <div class="card card-2">  
                ...
                <div class="card-body">
                    ...
                    <h2 class="title">ADD TABLE</h2>
                    
                  
                        <div class="input-group">
                            <input class="input--style-2" type="text" placeholder="Enter table number" name="tableid">
                        </div>
                        ...
                        <div class="input-group">
                            <div class="rs-select2 js-select-simple select--no-search">
                                <select name="class" >
                                    <option disabled="disabled" selected="selected" >Choose capacity</option>
                                    <option>1</option>
                                    <option>2</option>
                                    <option>3</option>
                                    <option>4</option>
                        ...
                        <div class="p-t-30">
                            ...
                            <button class="btn btn--radius btn--green" type="submit" name="view" >VIEW TABLE DETAILS</button>
                        </div>
                    </form>
                </div>
            </div>
